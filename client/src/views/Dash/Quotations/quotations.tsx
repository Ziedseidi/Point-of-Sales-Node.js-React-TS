...
import { FaEllipsisV, FaEye, FaEdit, FaTrash, FaFilePdf, FaCartPlus, FaCalendarAlt } from 'react-icons/fa';
...
const Quotations: React.FC = () => {
            ...
            {openMenu === row.index &&
              ReactDOM.createPortal(
                ...
                >
                  ...
                  <button
                    onClick={() => handleCreateSale(row.original)}
                    className="w-full text-left px-4 py-2 text-gray-700 hover:bg-gray-100 flex items-center space-x-2"
                  >
                    <FaCartPlus />
  ...
  const handleCreateSale = (product: any) => {
    console.log('Create Sale', product);
    // Ajouter la logique pour créer une vente
  };
